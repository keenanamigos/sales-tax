...
describe("StoreItem", () => {
    describe("isImported", () => {
        it("should return true when the description property contains the word 'imported'", () => {
            const item1: StoreItem = new StoreItem(1, "imported bottle of perfume at", 47.50);
        ...
        it("should return false when the description property does not contain the word 'imported'", () => {
            const item1: StoreItem = new StoreItem(1, "bottle of perfume at", 18.99);
    ...
    describe("isExempt", () => {
        it("should return true if the item is a book, food, or a medical product", () => {
            const item1: StoreItem = new StoreItem(1, "book at", 12.49);
            const item2: StoreItem = new StoreItem(1, "chocolate bar at", 0.85);
            const item3: StoreItem = new StoreItem(1, "packet of headache pills at", 9.75);
        ...
        it("should return false if it is not a book, food, or a medical product", () => {
            const item1: StoreItem = new StoreItem(1, "music CD", 14.99);
